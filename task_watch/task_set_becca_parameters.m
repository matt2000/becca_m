...
task.agent.grouper.PROPENSITY_UPDATE_RATE = 10 ^ (-4); 
task.agent.grouper.MAX_PROPENSITY = 0.5;
task.agent.grouper.GROUP_DISCOUNT = 0.4;
task.agent.grouper.NEW_GROUP_THRESHOLD = 0.15;
task.agent.grouper.MIN_SIG_CORR = 0.1; 
task.agent.grouper.MAX_GROUP_SIZE = 7; 
% 
% task.agent.feature_map.NEW_FEATURE_MARGIN = 0.95;
